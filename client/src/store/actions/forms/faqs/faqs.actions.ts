...
import { IFaqQuestion, IStoreFaqQuestionAction, IFaqAnswer, IStoreFaqAnswerAction, IEditFaq, IEditFaqAction, IDeleteFaq, IDeleteFaqAction } from "../../../interfaces/forms/faqs.interfaces";
...
export const EditFaqAction = (data: IEditFaq): IEditFaqAction => {
