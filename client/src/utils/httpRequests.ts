...
export const getTasks = async () => {
  return await axios
    .get('/api/companytask', httpRequestsConfig)
    .then(res => res.data)
...
export const postCompanyTask = async (data: any): Promise<any> => {
  return await axios.post('/api/companytask', data, httpRequestsConfig).catch(err => console.error(err));
};

// Achievements
export const getAchievements = async (): Promise<any> => {
  return await axios
    .get('/api/company-achievement', httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
export const postAchievement = async (data: any): Promise<any> => {
  return await axios.post('/api/company-achievement', data, httpRequestsConfig).catch(err => console.error(err));
};
export const updateAchievement = async (data: any): Promise<any> => {
  return await axios.post('/api/company-achievement/update', data, httpRequestsConfig).catch(err => console.error(err));
};
export const deleteAchievement = async (data: any): Promise<any> => {
  return await axios.post('/api/company-achievement/delete', data, httpRequestsConfig).catch(err => console.error(err));
};

// Categories
export const getCategories = async (): Promise<any> => {
  return await axios
    .get('/api/category', httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
export const getCategory = async (id: number): Promise<any> => {
  return await axios
    .get(`/api/category/specific/${id}`, httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
export const postCategory = async (data: any): Promise<any> => {
  return await axios.post('/api/category', data, httpRequestsConfig).catch(err => console.error(err));
};
export const updateCategory = async (data: any): Promise<any> => {
  return await axios.post('/api/category/update', data, httpRequestsConfig).catch(err => console.error(err));
};
export const deleteCategory = async (data: any): Promise<any> => {
  return await axios.post('/api/category/delete', data, httpRequestsConfig).catch(err => console.error(err));
};

// Departments
export const getDepartmentsTableInfo = async (): Promise<any> => {
  return await axios
    .get('/api/department/table', httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
export const getDepartments = async (): Promise<any> => {
  return await axios
    .get('/api/department', httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
export const getCompanyDepartments = async (): Promise<any> => {
  return await axios
    .get('/api/department/company-view', httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
export const getDepartment = async (id: number): Promise<any> => {
  return await axios
    .get(`/api/department/specific/${id}`, httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
export const postDepartment = async (data: any): Promise<any> => {
  return await axios.post('/api/department', data, httpRequestsConfig).catch(err => console.error(err));
};
export const updateDepartment = async (data: any): Promise<any> => {
  return await axios.post('/api/department/update', data, httpRequestsConfig).catch(err => console.error(err));
};
export const deleteDepartment = async (data: any): Promise<any> => {
  return await axios.post('/api/department/delete', data, httpRequestsConfig).catch(err => console.error(err));
};

// FAQ
export const getFAQs = async (): Promise<any> => {
  return await axios
    .get('/api/faq', httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
export const postFAQ = async (data: any): Promise<any> => {
  return await axios.post('/api/faq', data, httpRequestsConfig).catch(err => console.error(err));
};
export const updateFAQ = async (data: any): Promise<any> => {
  return await axios.post('/api/faq/update', data, httpRequestsConfig).catch(err => console.error(err));
};
export const deleteFAQ = async (data: any): Promise<any> => {
  return await axios.post('/api/faq/delete', data, httpRequestsConfig).catch(err => console.error(err));
};

// Roles
export const getRolesTableInfo = async (): Promise<any> => {
  return await axios
    .get('/api/role/table', httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
export const getRolesResponsibilities = async (): Promise<any> => {
  return await axios
    .get('/api/role/responsibilities/admin', httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
export const getRolesResponsibilitiesCompany = async (): Promise<any> => {
  return await axios
    .get('/api/role/responsibilities', httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
export const getRole = async (id: number): Promise<any> => {
  return await axios
    .get(`/api/role/specific/${id}`, httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
...
export const getBuddiesTableInfo = async (): Promise<any> => {
  return await axios
    .get('/api/company/buddy-table', httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
export const getEmployees = async (): Promise<any> => {
  return await axios
    .get('/api/company/employees', httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
export const getCompanyEmployees = async (): Promise<any> => {
  return await axios
    .get('/api/company', httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
export const postEmployee = async (data: any): Promise<any> => {
  return await axios
    .post('/api/auth/invite-employees', data, httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
...
export const postEmployeeAdminPanel = async (data: any): Promise<any> => {
  return await axios
    .post('/api/auth/invite-employee-admin', data, httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
...
export const getAssignedTasks = async (): Promise<any> => {
  return await axios
    .get('/api/assignedtask', httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
export const submitAssignedTask = async (data: any): Promise<any> => {
  return await axios
    .post('/api/assignedtask', data, httpRequestsConfig)
    .then(res => res.data)
    .catch(err => console.error(err));
};
